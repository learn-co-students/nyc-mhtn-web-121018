...
- we'll do it through TDD
- super, self <==
- modules, namespacing

Inheritance
- class to be copied into other classes
- one class can be the starting blueprint for another class

Module
- folder for your code
- code that is kinda shared
- you can pull it in as either class stuff
- or as instance stuff

Namespacing
- that's when you use a module just as a folder

PROGRAMMING IS CREATIVITY!
You can hack anything to work.
