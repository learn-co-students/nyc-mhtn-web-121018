...
class BurgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create burger" do
    assert_difference('Burger.count') do
      post burgers_url, params: { burger: { meat: @burger.meat, seed: @burger.seed, toppings: @burger.toppings } }
    end
  ...
  test "should update burger" do
    patch burger_url(@burger), params: { burger: { meat: @burger.meat, seed: @burger.seed, toppings: @burger.toppings } }
