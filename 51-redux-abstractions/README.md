...
- [ ] Abstract their action types into CONSTANTS and explain why that is a good thing.
- [ ] Abstract their actions into actionCreators and explain why that is a good thing.
- [ ] Refactor their code into separate files.
- [ ] Abstract their dispatch(actions) into mapDispatchToProps and see why we might want to do this.
- [ ] Understand BindActionCreators and the import trick.
- [ ] See the dual Component Hierarchy that exists when using Redux.
